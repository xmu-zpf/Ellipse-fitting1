...
namespace my {
	...
	wchar_t* wGetFileName(const char* title, const wchar_t* defualtPath = L"C:\\");
	auto Wchar_tToString(wchar_t* wchar) -> std::string;
	auto GetFileName(const char* title, const wchar_t* defualtPath = L"C:\\") -> std::string;
	auto GetSaveName(const char* title, const wchar_t* defualtPath) -> std::string;
	auto GetFolderName(const char* title) -> std::string;
